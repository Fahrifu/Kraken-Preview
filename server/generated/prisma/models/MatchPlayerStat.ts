...
// @ts-nocheck 
/*
 * This file exports the `MatchPlayerStat` model and its related types.
 *
...
export type GetMatchPlayerStatAggregateType<T extends MatchPlayerStatAggregateArgs> = {
      [P in keyof T & keyof AggregateMatchPlayerStat]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMatchPlayerStat[P]>
    : Prisma.GetScalarType<T[P], AggregateMatchPlayerStat[P]>
}
...
export type GetMatchPlayerStatGroupByPayload<T extends MatchPlayerStatGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MatchPlayerStatGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MatchPlayerStatGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MatchPlayerStatGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MatchPlayerStatGroupByOutputType[P]>
      }
    >
  >
...
export type MatchPlayerStatWhereInput = {
  ...
  id?: Prisma.IntFilter<"MatchPlayerStat"> | number
  label?: Prisma.StringFilter<"MatchPlayerStat"> | string
  value?: Prisma.StringFilter<"MatchPlayerStat"> | string
  category?: Prisma.StringNullableFilter<"MatchPlayerStat"> | string | null
  sortOrder?: Prisma.IntFilter<"MatchPlayerStat"> | number
  createdAt?: Prisma.DateTimeFilter<"MatchPlayerStat"> | Date | string
  updatedAt?: Prisma.DateTimeFilter<"MatchPlayerStat"> | Date | string
  matchId?: Prisma.IntFilter<"MatchPlayerStat"> | number
  playerId?: Prisma.IntFilter<"MatchPlayerStat"> | number
...
export type MatchPlayerStatScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.IntWithAggregatesFilter<"MatchPlayerStat"> | number
  label?: Prisma.StringWithAggregatesFilter<"MatchPlayerStat"> | string
  value?: Prisma.StringWithAggregatesFilter<"MatchPlayerStat"> | string
  category?: Prisma.StringNullableWithAggregatesFilter<"MatchPlayerStat"> | string | null
  sortOrder?: Prisma.IntWithAggregatesFilter<"MatchPlayerStat"> | number
  ...
  matchId?: Prisma.IntWithAggregatesFilter<"MatchPlayerStat"> | number
  playerId?: Prisma.IntWithAggregatesFilter<"MatchPlayerStat"> | number
}
...
export type MatchPlayerStatOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "label" | "value" | "category" | "sortOrder" | "createdAt" | "updatedAt" | "matchId" | "playerId", ExtArgs["result"]["matchPlayerStat"]>
...
export type MatchPlayerStatCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MatchPlayerStatFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MatchPlayerStatDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MatchPlayerStat'], meta: { name: 'MatchPlayerStat' } }
  /**
   ...
   * })
  **/
  count<T extends MatchPlayerStatCountArgs>(
    args?: Prisma.Subset<T, MatchPlayerStatCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MatchPlayerStatCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MatchPlayerStatGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MatchPlayerStatGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMatchPlayerStatGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface MatchPlayerStatFieldRefs {
  readonly id: Prisma.FieldRef<"MatchPlayerStat", 'Int'>
  readonly label: Prisma.FieldRef<"MatchPlayerStat", 'String'>
  readonly value: Prisma.FieldRef<"MatchPlayerStat", 'String'>
  readonly category: Prisma.FieldRef<"MatchPlayerStat", 'String'>
  readonly sortOrder: Prisma.FieldRef<"MatchPlayerStat", 'Int'>
  readonly createdAt: Prisma.FieldRef<"MatchPlayerStat", 'DateTime'>
  readonly updatedAt: Prisma.FieldRef<"MatchPlayerStat", 'DateTime'>
  readonly matchId: Prisma.FieldRef<"MatchPlayerStat", 'Int'>
  readonly playerId: Prisma.FieldRef<"MatchPlayerStat", 'Int'>
}
